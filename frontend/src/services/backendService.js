...
export async function getAllDailyChallenges(username) {
  return await fetch(`${baseUrl}statistics/daily/${username}/all`, {
    method: "GET"
  });
}
...
export async function submitDailyStatistics(
  username,
  coffee,
  foodScore,
  dailyChallenge,
